    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-32">
        <div className="max-w-3xl">
          ...
          {/* Description */}
          <p className="text-lg md:text-xl text-background/80 mb-8 max-w-2xl animate-slide-up" style={{ animationDelay: "0.2s" }}>
          ...
          {/* Stats */}
          <div className="grid grid-cols-3 gap-8 mt-12 pt-8 border-t border-background/20 animate-fade-in" style={{ animationDelay: "0.5s" }}>
            <div>
            ...
            <div>
              <p className="font-heading text-3xl md:text-4xl font-bold text-background">1000+</p>
              <p className="text-sm text-background/70">Happy Customers</p>
            </div>
            <div>
              <p className="font-heading text-3xl md:text-4xl font-bold text-background">5+</p>
